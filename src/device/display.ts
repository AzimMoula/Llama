...
export class WhisplayDisplay {
  ...
  private cameraDaemonEnabled: boolean;
  ...
  constructor() {
    ...
    this.cameraDaemonEnabled = parseBoolEnv(
      "WHISPLAY_CAMERA_DAEMON_ENABLED",
      true,
    );
    if (this.cameraEnabled && this.cameraDaemonEnabled) {
  ...
  killPythonProcess(): void {
    ...
    if (this.pythonProcess) {
      ...
      try {
        ...
        // Ignore ESRCH when process already exited.
      }
